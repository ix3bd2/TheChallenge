...
import * as types from '../../store/modules/microbit/update/mutation_types';
...
export default {
  ...
  computed: {
    ...
    ...mapFields('microbit/create', {
      created: 'created',
    }),
    ...mapFields('microbit/update', {
      isLoading: 'isLoading',
      error: 'error',
      item: 'retrieved',
      hubUrl: 'hubUrl',
    ...
    itemUpdateMutation: () => `microbit/update/${types.SET_RETRIEVED}`,
  ...
  methods: {
    ...mapActions({
      createReset: 'microbit/create/reset',
      deleteItem: 'microbit/del/del',
      delReset: 'microbit/del/reset',
      retrieve: 'microbit/update/retrieve',
      updateReset: 'microbit/update/reset',
      update: 'microbit/update/update',
      updateRetrieved: 'microbit/update/updateRetrieved',
    }),
